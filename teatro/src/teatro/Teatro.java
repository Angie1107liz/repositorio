...
public class Teatro {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ingrese la cantidad de persona que asistiran al teatro");
        ...
        for (int i = 0; i < cantPersonas; i++) {
            ...
            if (edad >= 5 && edad <= 14) {
                ...
                System.out.println("cantidad de personas en la categoria 1 (46-65 años)" + cant4);
                ...
                perdida5 = cant1 * precioAsiento * descuento5;
                
                System.out.println("el teatro deja de recibir $" + perdida1 + "en la categoria 1");
                System.out.println("el teatro deja de recibir $" + perdida2 + "en la categoria 2 ");
                System.out.println("el teatro deja de recibir $" + perdida3 + "en la categoria 3 ");
                System.out.println("el teatro deja de recibir $" + perdida4 + "en la categoria 4 ");
                System.out.println("el teatro deja de recibir $" + perdida5 + "en la categoria 5 ");
